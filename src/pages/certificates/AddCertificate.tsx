...
import { addUrlToFile, post, remove } from "../../utills";
...
export function AddCertificate() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await post("/certificates", values, true);
          ...
          <div className="col-md-12 grid-margin">
            <div className="d-flex justify-content-between align-items-center">
              <div className="d-flex gap-2">
                <GoBackButton />
                <h4 className="font-weight-bold mb-0">Add Certifiacte</h4>
              </div>
              {/* <div>
              <button
                type="button"
              ...
              <div className="card rounded-2 mt-4">
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="">
                      <SubmitButton loading={loading} text="Add Certificate" />
                    </div>
                  </div>
                </div>
              </div>
