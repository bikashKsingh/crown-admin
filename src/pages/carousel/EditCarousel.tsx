...
export function EditCarousel() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await put(`/carousels/${id}`, values);
  ...
  return (
    <>
      <ReactHelmet title="Edit Carousel : Crown" description="Edit Carousel" />
              ...
              <div className="card rounded-2 mt-4">
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="">
                      <SubmitButton loading={updating} text="Update Carousel" />
                    </div>
                  </div>
                </div>
              </div>
